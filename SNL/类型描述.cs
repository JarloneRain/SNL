...
namespace SNL {
    ...
    internal class 未知类型描述 : 类型描述 {
        ...
        public 未知类型描述() : base(0, 类型类别Enum.未知类型) { }
    }
    internal class 基础类型描述 : 类型描述 {
        ...
        public static 基础类型描述 整数类型(int 行号 = 0) => new 基础类型描述(行号) {
            行号 = 行号,
            类型类别 = 类型类别Enum.基础类型,
            类型 = 基础类型Enum.整数类型,
        };
        public static 基础类型描述 字符类型(int 行号 = 0) => new 基础类型描述(行号) {
            行号 = 行号,
            类型类别 = 类型类别Enum.基础类型,
            类型 = 基础类型Enum.字符类型,
        };
        public static 基础类型描述 布尔类型(int 行号 = 0) => new 基础类型描述(行号) {
            行号 = 行号,
            类型类别 = 类型类别Enum.基础类型,
            类型 = 基础类型Enum.布尔类型,
        };
        public 基础类型描述(int 行号) :
            base(行号, 类型类别Enum.基础类型) {
        }
    }
    internal class 记录类型描述 : 类型描述 {
        ...
        public 记录类型描述(int 行号) :
            base(行号, 类型类别Enum.记录类型) {
        }
    }
    internal class 数组类型描述 : 类型描述 {
        ...
        public override List<语义错误> 语义检查() => new() { 下界 <= 上界 ? 语义错误.OK : new 语义错误 {
            行号 = 行号,
            错误类别 =语义错误.  语义错误类别Enum.数组下标越界,
        }};
        public override string ToString() => $"ARRAY[{下界}..{上界}]{元素类型}";
        public 数组类型描述(int 行号, int 下界, int 上界, 基础类型描述 元素类型) :
            base(行号, 类型类别Enum.数组类型) {
            this.下界 = 下界;
            this.上界 = 上界;
            this.元素类型 = 元素类型;
        }
    ...
    internal class 自定类型描述 : 类型描述 {
        ...
        public 自定类型描述(int 行号, string 类型名) :
